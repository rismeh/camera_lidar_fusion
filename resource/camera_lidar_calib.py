...
def main(config_file, data_file, result_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config_file', help='Path to camera config.zaml file', required=True)
    parser.add_argument('-d', '--data_file', help='Path to camera data.txt file', required=True)
    parser.add_argument('-r', '--result_file', help='Path to calibration results file', required=True)
    args = parser.parse_args()

    main(args.config_file, args.data_file, args.result_file)
